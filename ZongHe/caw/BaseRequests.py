...
class BaseRequests:
    ...
    def get(self, url, **kwargs):
        try:
            # 使用requests的方式调用requests中的get接口
    ...
    def post(self, url, **kwargs):
        try:
            # 使用requests的方式调用requests中的post接口
...
if __name__ == '__main__':
    ...
    print(r.text)
    cans = {"mobilephone": 18012345678, "pwd": 123456}
    r = BaseRequests().post("http://jy001:8081/futureloan/mvc/api/member/login", data=cans)
    print(r.text)
